            ...
            SkillBuilder.createNewSkill(this, 三星被动)
                    ...
                    .act(
                            SkillBuilder.createNewSkill(this, 三星被动)
                                    ...
                                    .lastedTurn(6)
                                    .act(DamageAction.create(this, 普通伤害).multi(0.3).to(GameBoard.selectTarget(1)).build())
                                    .and()
                                    .act(DamageAction.create(this, 普通伤害).multi(0.3).to(GameBoard.selectTarget(2)).build())
                                    .and()
                                    .act(DamageAction.create(this, 普通伤害).multi(0.3).to(GameBoard.selectTarget(5)).build())
                                    .toAction()
                    )
                    .build();
        }
