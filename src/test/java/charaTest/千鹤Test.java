...
class 千鹤Test {
    ...
    @Test
    void 创建千鹤测试() {
        Chara 千鹤 = ImportedChara.initChara("复生公主_千鹤");
        GameBoard.getInstance().addOurChara(千鹤);
    }

    @Test
    void 千鹤尝试攻击() {
        Chara 千鹤 = ImportedChara.initChara("复生公主_千鹤 攻击力100");
    ...
    @Test
    void 千鹤先大招再攻击() {
        Chara 千鹤 = ImportedChara.initChara("复生公主_千鹤 攻击力100 星3 绊1 潜5");
    ...
    @Test
    void 千鹤队长的大招() {
        Chara 千鹤 = ImportedChara.initChara("复生公主_千鹤 攻击力100 队长 星3 绊1 潜6");
    ...
    @Test
    void 千鹤沃沃联手大战精灵王测试() {
        Chara 千鹤 = ImportedChara.initChara("复生公主_千鹤 攻击力361418 队长 星3 绊1 潜6");
    ...
    void 沃沃千鹤联手大战精灵王测试() {
        ...
        Chara 沃沃 = ImportedChara.initChara("胆小纸袋狼_沃沃 队长 攻击力204650 星3 绊2 潜5");
        木桩 精灵王 = 木桩.init("生命11821290");
        board.addOurChara(沃沃);
        board.addOurChara(千鹤);
        board.addEnemyChara(精灵王);
